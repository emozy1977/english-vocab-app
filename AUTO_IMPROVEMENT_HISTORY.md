...
- 2026-05-31: 苦手優先と新規単語混在ロジックのテストケースを増やす。 — Add additional unit tests covering mixed ordering of new and difficult words and next_id rotation behavior to increase coverage for the 'difficult-first and new-words mix' logic.
