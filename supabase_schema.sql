...
create index if not exists study_events_studied_on_idx on public.study_events (studied_on);
create index if not exists study_events_studied_at_idx on public.study_events (studied_at desc);
create index if not exists study_events_word_id_idx on public.study_events (word_id);

grant select, insert, update, delete on table public.study_events to service_role;
